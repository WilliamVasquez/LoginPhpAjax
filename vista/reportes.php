	...
	<div class="container mt-5">
		<div class="row">
			<div class="card-deck col-sm-12">
				<div class="card">
					<img src="../assets/images/reporte-todo.svg" class="card-img-top img-fluid img-btn p-4" alt="report_all">
					<div class="card-body">
				...
				<div class="card">
					<img src="../assets/images/reporte-filtros.svg" class="card-img-top img-fluid img-btn p-4" alt="REPORT_FILTRADO">
					<div class="card-body">
				...
				<div class="card">
					<img src="../assets/images/report-otros.svg" class="card-img-top img-fluid img-btn p-4" alt="REPORT_OTROS">
					<div class="card-body">
